...
const starts = async (helga = new WAConnection()) => {
	...
	console.log(color(figlet.textSync('ZenXBotz', {
		font: 'Standard',
	...
	console.log(color('\n> GitHub : ','red'), color(`Alphabotz`,'white'))
	console.log(color('> YouTube : ','red'), color(`Alphabotz`,'white'))
...
console.log(color('\n\n\n Big Thanks To\n\n','orange'), color(`Allah SWT\nMy Parents\nMy Family\nHelga Ilham\n`,'purple'))
	helga.browserDescription = [ 'ZenX', 'ubuntu', '3.0' ]
